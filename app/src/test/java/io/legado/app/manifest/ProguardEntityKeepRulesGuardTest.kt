...
class ProguardEntityKeepRulesGuardTest {
    ...
    fun entityKeepRulesAreExplicitlyScoped() {
        ...
        assertTrue(
            "BookGroup keep should be narrowed to field-level retention",
        ...
        assertFalse(
            "RssArticle entity should not be blanket-kept when no backup/import-export JSON contract requires it",
            rules.contains("-keep class io.legado.app.data.entities.RssArticle { *; }")
        )
        assertFalse(
