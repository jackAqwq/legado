...
object AppConfig : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    var recordPerformanceMetrics = appCtx.getPrefBoolean(PreferKey.performanceMetrics, false)
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
        when (key) {
            ...
            PreferKey.performanceMetrics -> recordPerformanceMetrics =
                appCtx.getPrefBoolean(PreferKey.performanceMetrics, false)
