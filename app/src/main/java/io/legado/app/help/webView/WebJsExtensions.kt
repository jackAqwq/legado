...
class WebJsExtensions(
    ...
    @JavascriptInterface
    fun webView(html: String?, url: String?, js: String?, _useJs: Boolean): String? {
        return super.webView(html, url, js)
    }
    ...
    fun webViewGetSource(
        ...
        return super.webViewGetSource(html, url, js, sourceRegex)
    }
