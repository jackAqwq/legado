...
-keep class io.legado.app.lib.theme.view.ThemeBottomNavigationVIew { *; }
-keep class io.legado.app.lib.theme.view.ThemeCheckBox { *; }
-keep class io.legado.app.lib.theme.view.ThemeEditText { *; }
-keep class io.legado.app.lib.theme.view.ThemeProgressBar { *; }
-keep class io.legado.app.lib.theme.view.ThemeRadioButton { *; }
-keep class io.legado.app.lib.theme.view.ThemeRadioNoButton { *; }
-keep class io.legado.app.lib.theme.view.ThemeSeekBar { *; }
-keep class io.legado.app.lib.theme.view.ThemeSwitch { *; }
-keep class io.legado.app.ui.book.manga.recyclerview.WebtoonFrame { *; }
-keep class io.legado.app.ui.book.manga.recyclerview.WebtoonRecyclerView { *; }
-keep class io.legado.app.ui.book.read.config.ChineseConverter { *; }
-keep class io.legado.app.ui.book.read.config.TextFontWeightConverter { *; }
-keep class io.legado.app.ui.book.read.MangaMenu { *; }
-keep class io.legado.app.ui.book.read.page.ContentTextView { *; }
-keep class io.legado.app.ui.book.read.page.ReadView { *; }
-keep class io.legado.app.ui.book.read.ReadMenu { *; }
-keep class io.legado.app.ui.book.read.SearchMenu { *; }
-keep class io.legado.app.ui.widget.anima.RefreshProgressBar { *; }
-keep class io.legado.app.ui.widget.anima.RotateLoading { *; }
-keep class io.legado.app.ui.widget.BatteryView { *; }
-keep class io.legado.app.ui.widget.checkbox.SmoothCheckBox { *; }
-keep class io.legado.app.ui.widget.code.CodeView { *; }
-keep class io.legado.app.ui.widget.DetailSeekBar { *; }
-keep class io.legado.app.ui.widget.dynamiclayout.DynamicFrameLayout { *; }
-keep class io.legado.app.ui.widget.image.ArcView { *; }
-keep class io.legado.app.ui.widget.image.CircleImageView { *; }
-keep class io.legado.app.ui.widget.image.CoverImageView { *; }
-keep class io.legado.app.ui.widget.image.FilletImageView { *; }
-keep class io.legado.app.ui.widget.image.ImageButton { *; }
-keep class io.legado.app.ui.widget.image.PhotoView { *; }
-keep class io.legado.app.ui.widget.LabelsBar { *; }
-keep class io.legado.app.ui.widget.NoChildScrollNestedScrollView { *; }
-keep class io.legado.app.ui.widget.ReaderInfoBarView { *; }
-keep class io.legado.app.ui.widget.recycler.RecyclerViewAtPager2 { *; }
-keep class io.legado.app.ui.widget.recycler.scroller.FastScrollRecyclerView { *; }
-keep class io.legado.app.ui.widget.SearchView { *; }
-keep class io.legado.app.ui.widget.seekbar.VerticalSeekBar { *; }
-keep class io.legado.app.ui.widget.seekbar.VerticalSeekBarWrapper { *; }
-keep class io.legado.app.ui.widget.SelectActionBar { *; }
-keep class io.legado.app.ui.widget.text.AccentBgTextView { *; }
-keep class io.legado.app.ui.widget.text.AccentStrokeTextView { *; }
-keep class io.legado.app.ui.widget.text.AccentTextView { *; }
-keep class io.legado.app.ui.widget.text.AutoCompleteTextView { *; }
-keep class io.legado.app.ui.widget.text.BadgeView { *; }
-keep class io.legado.app.ui.widget.text.BevelLabelView { *; }
-keep class io.legado.app.ui.widget.text.MultilineTextView { *; }
-keep class io.legado.app.ui.widget.text.ScrollTextView { *; }
-keep class io.legado.app.ui.widget.text.StrokeTextView { *; }
-keep class io.legado.app.ui.widget.text.TextInputLayout { *; }
